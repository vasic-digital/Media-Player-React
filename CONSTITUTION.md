# CONSTITUTION — Media-Player-React

Project-specific governance for the **Media-Player-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
